...
class OnBoardingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => IntroductionScreen(
        pages: [
          PageViewModel(
            title: "❤ Ethan Baby Wear and Accessories ❤ မှ နွေးထွေးစွာ ကြိုဆိုလိုက်ပါတယ် 🇲🇲 ",
            body: '''''',
            image: buildImage('assets/logo2.png'),
...
//             ),
          ...
          //   ),
          PageViewModel(
            title: '❤  Baby wears, accessories & food များကို တစ်နေရာတည်းမှာ မိမိစိတ်ကြိုက် စိတ်ချစွာ ဝယ်ယူအားပေးနိုင်ပါတယ်ရှင်...  ❤',
            body: '''''',
            footer: ButtonWidget(
